package com.vovka.egov66client.ui.components.accordion;
...
public class AccordionView extends RelativeLayout {
   ...
   // int paragraphHeight;
    ...
    private void handleAttributeSet(Context context, AttributeSet attts) {
        ...
        messageString = a.getString(R.styleable.accordion_message);
    ...
    private void initializeViewWithoutChildren(Context context) {
        ...
        message = accordionLayout.findViewById(R.id.message);
    ...
    private void setOnClickListenerOnHeading() {
        ...
        message.setOnClickListener(toggleParagraphVisiblity);
     ...
     * @param messageString
     */
    public void setMessageString(String messageString) {message.setText(messageString);}
