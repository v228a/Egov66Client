...
import com.vovka.egov66client.databinding.ItemYearGradeCompactBinding
...
class YearGradesCompactAdapter(
    private val yearGradesList: List<YearGradeEntity>,
) : RecyclerView.Adapter<YearGradesCompactAdapter.YearGradeViewHolder>() {
    ...
    inner class YearGradeViewHolder(val binding: ItemYearGradeCompactBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YearGradeViewHolder {
        val binding = ItemYearGradeCompactBinding.inflate(
    ...
    override fun onBindViewHolder(holder: YearGradeViewHolder, position: Int) {
        ...
        // Настраиваем заголовки периодов и заполняем данные
    ...
    private fun setupPeriodData(binding: ItemYearGradeCompactBinding, periodGrades: List<YearPeriodGradeEntity>) {
    ...
    private fun clearPeriodContainers(binding: ItemYearGradeCompactBinding) {
